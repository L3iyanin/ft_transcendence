...
const LastMatches = ({ children }: { children: IGameMatch[] }) => {
	return (
		<section className="container h-full m-4 min-w-[530px] max-w-[819px] w-4/5 p-4 rounded-lg flex flex-col justify-center items-start gap-2 bg-dark-60 text-white">
